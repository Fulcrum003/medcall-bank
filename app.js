...
function viewQuiz(){
  ...
  if(q.type==="sa"){
    ...
    if(!s.revealed){
      html+=`<div class="card pad" style="border-left:3px solid var(--amber)"><div class="faint" style="font-size:13px;line-height:1.55">⚑ <b>Recalled question</b> — the source preserved only the answer, not the full option list. Tap <b>Reveal answer</b> to see it.</div></div>`;
    } else {
