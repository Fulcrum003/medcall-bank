...
export let DB = {
  progress:{ questions:{}, resume:null, streak:{current:0,lastStudied:null}, checklist:{} },
  exams:[],
  reports:[],
...
export function resetDB() {
  DB.progress = { questions: {}, resume: null, streak: { current: 0, lastStudied: null }, checklist: {} };
  DB.exams = [];
  DB.reports = [];
