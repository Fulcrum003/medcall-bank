...
function viewSettings(){
  ...
  let html=`<div class="fade">
    ...
    <div class="empty" style="padding-top:24px" data-action="maint-tap">MedCall · v1.1<br>Storage: ${STORE.kind==='local'?'saved on this device':STORE.kind==='artifact'?'saved (preview)':'this session only'}.</div>
  </div>`;
  return html;
}
