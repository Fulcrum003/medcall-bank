...
export let DB = {
  ...
  exams:[],
  reports:[],
  settings:{ onboarded:false, account:{mode:"",uid:"",email:"",lastSync:"",autoSync:true}, newPerDay:20, passMark:50, maintainer:false, wallpaper:"ink", theme:"dark", dailyGoal:20, sounds:true, examDate:"", revealOnPick:true, srsGrading:true, notif:{ enabled:false, daily:true, due:true, streak:true, exam:true, time:"19:00", lastFired:{} } }
};
...
export function resetDB() {
  ...
  DB.exams = [];
  DB.reports = [];
  DB.settings = { onboarded:false, account:{mode:"",uid:"",email:"",lastSync:"",autoSync:true}, newPerDay: 20, passMark: 50, maintainer: false, wallpaper: "ink", theme: "dark", dailyGoal: 20, sounds: true, examDate: "", revealOnPick: true, srsGrading: true, notif: { enabled:false, daily:true, due:true, streak:true, exam:true, time:"19:00", lastFired:{} } };
}
/* clinic-v2.5 */
